...
### Q4: "How do the Live Camera Feed and Digital Twin map operate?"

**A:**

- **Live Camera Feed**: Streams via `/api/video-feed` using MJPEG multipart response encoding, connecting directly to physical ESP32-CAM HTTP streams or server synthetic camera pipelines.
